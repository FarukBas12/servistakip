        ...
        if (trans.type === 'odeme') {
            ...
            try {
                ...
                setEditPaymentData({
                    ...
                    existing_photos: data.photos ? JSON.parse(data.photos) : (data.waybill_image ? [data.waybill_image] : []),
                    new_photos: []
                });
                    ...
                    <div style={{ maxWidth: '800px', margin: '0 auto', background: '#1e1e1e', borderRadius: '10px', padding: '20px', border: '1px solid #333' }}>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px', marginBottom: '20px' }}>
                            ...
                            <div>
                                ...
                                {detailData.photos ? JSON.parse(detailData.photos).map((photo, i) => (
                                    <div key={i} style={{ marginTop: '10px' }}>
                                        <p><strong>Fotoğraf {i + 1}:</strong></p>
                                        <a href={photo.startsWith('http') ? photo : api.defaults.baseURL.replace('/api', '') + photo} target="_blank" rel="noreferrer">
                                            <img
