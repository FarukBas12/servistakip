                        ...
                        return (
                            ...
                            >
                                <div style={{ padding: '20px' }}>
                                    ...
                                    <p style={{ color: '#aaa', fontSize: '0.9rem', height: '40px', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                                        {project.description || 'Açıklama yok'}
                                    </p>

                                    <div style={{ marginTop: '15px', display: 'flex', gap: '15px', fontSize: '0.85rem', color: '#888' }}>
